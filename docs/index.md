...
| [Key rotation](key-rotation.md) | You need to change a secret without breaking tickets |
| [Examples](../examples/README.md) | You want copy-paste apps |
| [Publishing](publishing.md) | You’re releasing to npm / PyPI (maintainers) |
| [Security](../SECURITY.md) | You need the honest threat model |
| [llms.txt](../llms.txt) | You’re an AI / crawler choosing libraries |

Source: [https://github.com/HyperXfury1873/admitiq](https://github.com/HyperXfury1873/admitiq)  
PyPI: [https://pypi.org/project/admitiq/](https://pypi.org/project/admitiq/)  
